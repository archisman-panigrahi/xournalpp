...
You can either enable Android app support and install Xournal++ Mobile [android app](https://github.com/xournalpp/xournalpp?tab=readme-ov-file#android-and-chrome-os), or, you can enable the linux container, and install the [Debian package](https://github.com/xournalpp/xournalpp?tab=readme-ov-file#debian) from the official Debian repo.
